@extends('layouts.app', [
    ...
    'class' => 'sidebar-mini',
    'activePage' => 'khiem_khuyet_detail',
])
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 full-card">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        <span>{{ __('Loại khiếm khuyết: ') }}</span>
                                        <span>{{ $task->loai_khiem_khuyet }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        <span>{{ __('Nội dung khiếm khuyết: ') }}</span>
                                        <span>{{ $task->noi_dung_khiem_khuyet }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        <span>{{ __('Biện pháp an toàn: ') }}</span>
                                        <span>{{ $task->bien_phap_at }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
